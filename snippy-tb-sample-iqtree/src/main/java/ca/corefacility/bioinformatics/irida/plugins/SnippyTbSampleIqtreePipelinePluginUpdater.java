...
public class SnippyTbSampleIqtreePipelinePluginUpdater implements AnalysisSampleUpdater {
	...
	/**
	 * Builds a new {@link SnippyTbSampleIqtreePipelinePluginUpdater} with the given
	 * services.
	 * 
	 ...
	 */
	public SnippyTbSampleIqtreePipelinePluginUpdater(MetadataTemplateService metadataTemplateService,
			SampleService sampleService, IridaWorkflowsService iridaWorkflowsService) {
	...
	public AnalysisType getAnalysisType() {
		return SnippyTbSampleIqtreePipelinePlugin.SNIPPY_PHYLOGENOMICS;
	}
}
