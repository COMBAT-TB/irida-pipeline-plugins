...
cd irida-pipeline-plugins/tb-vcf-report-pipeline-plugin
mvn clean package
```

Once complete, you should end up with a file `target/tb-vcf-report-pipeline-plugin-0.1.1-SNAPSHOT.jar` which can be installed as a plugin to IRIDA.
