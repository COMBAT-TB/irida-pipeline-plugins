 ...
 */
public class ReportPipelinePlugin extends Plugin {
	...
	public ReportPipelinePlugin(PluginWrapper wrapper) {
		super(wrapper);
	}
	...
	public static class PluginInfo implements IridaPlugin {
		...
		public UUID getDefaultWorkflowUUID() {
			return UUID.fromString("18391fb9-337c-4b88-ab7c-5081b955a943");
		}
		...
		public Optional<AnalysisSampleUpdater> getUpdater(MetadataTemplateService metadataTemplateService,
			...
			return Optional.of(new ReportPluginUpdater(metadataTemplateService, sampleService, iridaWorkflowsService));
		}
	}
}
