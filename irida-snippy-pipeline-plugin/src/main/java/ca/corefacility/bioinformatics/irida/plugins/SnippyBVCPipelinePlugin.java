 ...
 */
public class SnippyBVCPipelinePlugin extends Plugin {
	 ...
	 * for each pipeline).
	 */
	public static final AnalysisType SNIPPY_BACTERIAL_VARIANT_CALLER = new AnalysisType("SNIPPY_BACTERIAL_VARIANT_CALLER");

	public SnippyBVCPipelinePlugin(PluginWrapper wrapper) {
		super(wrapper);
	}
	...
	public static class PluginInfo implements IridaPlugin {
		...
		public AnalysisType getAnalysisType() {
			return SNIPPY_BACTERIAL_VARIANT_CALLER;
		}
		...
		public UUID getDefaultWorkflowUUID() {
			return UUID.fromString("70b13025b-e857-4e4e-93dc-1c37af864ab4");
		}
		...
		public Optional<Color> getBackgroundColor() {
			return Optional.of(Color.decode("#47C0BA"));
		}
		...
		public Optional<AnalysisSampleUpdater> getUpdater(MetadataTemplateService metadataTemplateService,
			...
			return Optional.of(new SnippyBVCPluginUpdater(metadataTemplateService, sampleService, iridaWorkflowsService));
		}
	}
}
